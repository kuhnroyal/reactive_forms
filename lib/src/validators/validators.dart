...
import 'package:sk_reactive_forms/src/validators/any_validator.dart';
import 'package:sk_reactive_forms/src/validators/compare_validator.dart';
import 'package:sk_reactive_forms/src/validators/compose_or_validator.dart';
import 'package:sk_reactive_forms/src/validators/compose_validator.dart';
import 'package:sk_reactive_forms/src/validators/contains_validator.dart';
import 'package:sk_reactive_forms/src/validators/credit_card_validator.dart';
import 'package:sk_reactive_forms/src/validators/email_validator.dart';
import 'package:sk_reactive_forms/src/validators/equals_validator.dart';
import 'package:sk_reactive_forms/src/validators/max_length_validator.dart';
import 'package:sk_reactive_forms/src/validators/max_validator.dart';
import 'package:sk_reactive_forms/src/validators/min_length_validator.dart';
import 'package:sk_reactive_forms/src/validators/min_validator.dart';
import 'package:sk_reactive_forms/src/validators/must_match_validator.dart';
import 'package:sk_reactive_forms/src/validators/number_validator.dart';
import 'package:sk_reactive_forms/src/validators/pattern/default_pattern_evaluator.dart';
import 'package:sk_reactive_forms/src/validators/pattern/pattern_evaluator.dart';
import 'package:sk_reactive_forms/src/validators/pattern/regex_pattern_evaluator.dart';
import 'package:sk_reactive_forms/src/validators/pattern_validator.dart';
import 'package:sk_reactive_forms/src/validators/required_validator.dart';
...
typedef ValidatorFunction = Map<String, dynamic>? Function(AbstractControl<dynamic> control);

/// Signature of a function that receives a control and returns a Future
/// that emits validation errors if present, otherwise null.
typedef AsyncValidatorFunction = Future<Map<String, dynamic>?> Function(AbstractControl<dynamic> control);
...
class Validators {
  ...
  static ValidatorFunction get requiredTrue => EqualsValidator<bool>(true, validationMessage: ValidationMessage.requiredTrue).validate;
  ...
  static ValidatorFunction equals<T>(T value) => EqualsValidator<T>(value).validate;
  ...
  static ValidatorFunction minLength(int minLength) => MinLengthValidator(minLength).validate;

  /// Gets a validator that requires the length of the control's value to be
  /// less than or equal to the provided [maxLength].
  ///
  /// The argument [maxLength] must not be null.
  static ValidatorFunction maxLength(int maxLength) => MaxLengthValidator(maxLength).validate;
  ...
  static ValidatorFunction pattern(
    ...
    return PatternValidator(evaluator, validationMessage: validationMessage).validate;
  }
  ...
  static ValidatorFunction compare(
    ...
    return CompareValidator<dynamic>(controlName, compareControlName, compareOption).validate;
  }
