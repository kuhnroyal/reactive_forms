...
class Iso8601DateTimeValueAccessor extends ControlValueAccessor<String, DateTime> {
  @override
  DateTime? modelToViewValue(String? modelValue) {
    return modelValue == null || modelValue.trim().isEmpty ? null : DateTime.parse(modelValue);
  }
